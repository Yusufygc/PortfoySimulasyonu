...
_FT_CSS = (
    ...
    ".tbl-wrap{max-height:680px;overflow-x:auto;overflow-y:auto;border:1px solid #334155;border-radius:6px}"
    ".tbl-wrap::-webkit-scrollbar{width:8px;height:8px}"
    ".tbl-wrap::-webkit-scrollbar-track{background:#0a1628}"
    ".tbl-wrap::-webkit-scrollbar-thumb{background:#334155;border-radius:4px}"
    ".tbl-wrap::-webkit-scrollbar-thumb:hover{background:#00D4FF}"
