...
class TradeFormPanel(QFrame):
    ...
    def _init_ui(self):
        ...
        layout.addLayout(self._build_trade_form())
        self._build_total_and_action(layout)
        self._update_trade_mode_ui()

    def _build_side_selector(self) -> QHBoxLayout:
    ...
    def _build_trade_form(self) -> QFormLayout:
        form = QFormLayout()
        form.setSpacing(15)
        form.addRow(L10N.ISLEM_YONU, self._build_side_selector())
    ...
    def _build_total_and_action(self, layout) -> None:
