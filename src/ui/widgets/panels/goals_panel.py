# src/ui/widgets/panels/goals_panel.py
"""
...
class GoalsPanel(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        self._btn_add = QPushButton("➕ Yeni Hedef")
        ...
        self._btn_contribute = QPushButton("💵 Katkı Ekle")
        self._btn_contribute.setCursor(Qt.PointingHandCursor)
        ...
        self._btn_analyze = QPushButton("📊 Fizibilite Analizi")
